...
from model import resnet18_small as resnet18_small  # as wideresnet34
...
if __name__ == '__main__':
    ...
    checkpoint_list = [
        # '../LaTower/multar-wide-softower25-0-cifar10.pth',
        '../LaTower/checkpoint/more-Clean-soft00-cifar10.pth',
        '../LaTower/checkpoint/more-Clean-soft25-cifar10.pth',
        '../LaTower/checkpoint/more-Clean-soft50-cifar10.pth',
        '../LaTower/checkpoint/more-Clean-soft75-cifar10.pth',
        '../LaTower/checkpoint/Uniform-cifar10.pth',
        '../LaTower/checkpoint/more-Vertex-soft75-cifar10.pth',
        '../LaTower/checkpoint/more-Vertex-soft50-cifar10.pth',
        '../LaTower/checkpoint/more-Vertex-soft25-cifar10.pth',
        '../LaTower/checkpoint/more-Vertex-soft00-cifar10.pth',
    ]
