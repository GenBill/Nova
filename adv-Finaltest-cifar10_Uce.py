...
if __name__ == '__main__':
    ...
    checkpoint_list = [
        'check4/clean-final-cifar10.pth',
        'check4/shades-clean-final-cifar10-Uce-10.pth',
        'check4/shades-clean-final-cifar10-Uce-09.pth',
        'check4/shades-clean-final-cifar10-Uce-08.pth',
        'check4/shades-clean-final-cifar10-Uce-07.pth',
        'check4/shades-clean-final-cifar10-Uce-06.pth',
        'check4/shades-clean-final-cifar10-Uce-05.pth',
        'check4/shades-clean-final-cifar10-Uce-04.pth',
        'check4/shades-clean-final-cifar10-Uce-03.pth',
        'check4/shades-clean-final-cifar10-Uce-02.pth',
        'check4/shades-clean-final-cifar10-Uce-01.pth',
    ]
