...
if __name__ == '__main__':
    ...
    checkpoint_list = [
        'check4/clean-final-svhn.pth',
        'check4/shades-clean-final-svhn-Uce-10.pth',
        'check4/shades-clean-final-svhn-Uce-09.pth',
        'check4/shades-clean-final-svhn-Uce-08.pth',
        'check4/shades-clean-final-svhn-Uce-07.pth',
        'check4/shades-clean-final-svhn-Uce-06.pth',
        'check4/shades-clean-final-svhn-Uce-05.pth',
        'check4/shades-clean-final-svhn-Uce-04.pth',
        'check4/shades-clean-final-svhn-Uce-03.pth',
        'check4/shades-clean-final-svhn-Uce-02.pth',
        'check4/shades-clean-final-svhn-Uce-01.pth',
    ]
