...
if __name__ == '__main__':
    ...
    checkpoint_list = [
        './checkpoint/clean-final-cifar100.pth',
        './checkpoint/adv-final-cifar100.pth',
        './checkpoint/shades-clean-final-cifar100.pth',
        './checkpoint/shades-adv-final-cifar100.pth',
        # './checkpoint/double-adv-final-cifar100.pth',
        './checkpoint/mesa-adv-final-cifar100.pth',
        './checkpoint/target-' + gamma_name + '-cifar100.pth',
        './checkpoint/tarsha-' + gamma_name + '-cifar100.pth',
    ]
