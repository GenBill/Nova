...
if __name__ == '__main__':
    ...
    checkpoint_list = [
        './checkpoint/clean-final-mini.pth',
        './checkpoint/adv-final-mini.pth',
        './checkpoint/shades-clean-final-mini.pth',
        './checkpoint/shades-adv-final-mini.pth',
        './checkpoint/mesa-adv-final-mini.pth',

    ]

    os.environ['DATAROOT'] = '~/Datasets/ilsvrc2012'
