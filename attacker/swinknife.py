...
class SwinKnifePGD(nn.Module):
    """Projected Gradient Decent(PGD) attack.
    Can be used to adversarial training.
    """
    def __init__(self, model, eps=8/255, eps_iter=2/255, nb_iter=20, class_num=10, criterion=None, rand_init=True, targeted=False, doubled=True):
        super(SwinKnifePGD, self).__init__()
        # Arguments of PGD
