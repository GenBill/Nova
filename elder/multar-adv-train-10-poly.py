...
from runner import PolyRunner as TargetRunner
...
def run(lr, epochs, batch_size, gamma=0.5):
    ...
    # scheduler0 = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[24], gamma=1.4)
    ...
    scheduler3 = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[320,340], gamma=0.1)
    # scheduler2 = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[100, 140, 180, 220], gamma=0.32)
...
if __name__ == '__main__':
    ...
    writer = SummaryWriter('./runs/cifar10-poly')
    writertail = SummaryWriter('./runs/cifar10tail-poly')
