...
def run(lr, epochs, batch_size, gamma=0.5):
    ...
    scheduler2 = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[100, 160, 220, 260], gamma=0.1)
    ...
    # runner = TargetRunner(20, model, train_loader, shadow_loader, test_loader, criterion, optimizer, scheduler, attacker, train_dataset.class_num, device, gamma)
...
if __name__ == '__main__':
    ...
    writer = SummaryWriter('./runs/cifar100sub10')
