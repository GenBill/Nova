...
from runner import FrostRunner_KM
...
def run(lr, epochs, batch_size):
    ...
    runner = FrostRunner_KM(epochs, model, train_loader, test_loader, criterion, optimizer, scheduler, attacker, train_dataset.class_num, device)
