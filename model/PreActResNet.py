...
def loadmodel18(device, num_channels=3, num_classes=10):

    model = preactresnet18( False, num_classes=num_classes, num_channels=num_channels ).to(device)
    for module in model.modules():
        if isinstance(module, nn.Conv2d):
            nn.init.kaiming_normal_(module.weight.data)
        elif isinstance(module, nn.BatchNorm2d) and len(module.weight.shape) > 1:
            nn.init.kaiming_normal_(module.weight.data)
