...
class PreActResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, normalize = False, normalize_only_FN = False, scale = 15, activation='ReLU', softplus_beta=1, use_projector=False):
        ...
        # if use_projector:
        #     self.projector = MLP(512*block.expansion, 512*block.expansion, 512*block.expansion)
...
def PreActResNet18(num_classes=10, normalize = False, normalize_only_FN = False, scale = 15, activation='ReLU', softplus_beta=1, use_projector=False):
    return PreActResNet(PreActBlock, [2,2,2,2], num_classes=num_classes, normalize = normalize
        , normalize_only_FN = normalize_only_FN, scale = scale, activation=activation, softplus_beta=softplus_beta, use_projector=use_projector)
