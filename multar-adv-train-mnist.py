...
def run(lr, epochs, batch_size, gamma=0.5):
    ...
    train_dataset = MNIST(os.environ['DATAROOT'], transform=train_transforms, train=True)
    ...
    test_dataset = MNIST(os.environ['DATAROOT'], transform=test_transforms, train=False)
    ...
    if torch.distributed.get_rank() == 0:
        ...
        torch.save(model.cpu(), './checkpoint/multar-plain128-mnist.pth')
        print('Save model.')
